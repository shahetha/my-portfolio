...
export default function Hero3D() {
  ...
  return (
    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-[1.05fr_0.95fr] gap-10 md:gap-16 items-center px-4 sm:px-6">
      {/* Text column */}
      <div className="text-center md:text-left w-full">
        <motion.p
          ...
          className="text-xl sm:text-2xl md:text-3xl text-neutral-200 font-semibold mb-2"
        >
          Hi, I am
        </motion.p>
        ...
        >
          <span className="block sm:inline">Shahetha</span>{" "}
          <span className="block sm:inline">Shanmugam</span>
        </motion.h1>
        ...
        <motion.h2
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          className="mt-4 text-2xl sm:text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 via-fuchsia-300 to-violet-500"
        >
          {roles[roleIndex]}
        </motion.h2>
        ...
        <motion.p
          ...
          className="mt-6 text-base sm:text-lg md:text-xl text-neutral-300 leading-relaxed max-w-xl mx-auto md:mx-0"
        >
          I build scalable software, cloud systems, and AI-driven applications
          using Python, Java, JavaScript, and AWS.
        </motion.p>

        <div className="mt-8 flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center md:justify-start items-center sm:items-start">
          <a
            href="/Resume.pdf"
            target="_blank"
            rel="noopener noreferrer"
            className="w-[220px] sm:w-auto px-6 py-3 sm:px-8 sm:py-4 rounded-2xl bg-gradient-to-r from-fuchsia-500 to-violet-500 text-white text-lg font-bold shadow-[0_0_30px_rgba(168,85,247,0.35)] hover:scale-105 hover:brightness-110 transition text-center"
          >
            Resume
          </a>
        ...
        <div className="mt-10 sm:mt-14 flex gap-4 justify-center md:justify-start">
          <a
      ...
      {/* 3D column */}
      <div className="relative h-[260px] sm:h-[320px] md:h-[520px] overflow-hidden md:translate-x-12">
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="h-40 w-40 sm:h-56 sm:w-56 md:h-72 md:w-72 rounded-full bg-violet-500/10 blur-3xl" />
        </div>
